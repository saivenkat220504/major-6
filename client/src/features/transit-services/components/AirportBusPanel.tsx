...
const LOADING_STEPS = [
  {
    ...
    icon: Search,
    label: (code: string) => `Checking Bus connectivity at ${code}…`,
  ...
  },
  {
    ...
    subtitle: 'Finding official website, routes & schedules',
  },
  {
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-extrabold text-white">Bus Connectivity</h3>
                  ...
                  >
                    ...
                    >
                      {isDone ? (
                        ...
                        <Icon
                          size={17}
                          className={isActive ? 'text-emerald-400 animate-pulse' : 'text-slate-500'}
                        />
                      )}
                    </div>
                    <div>
      ...
      <AnimatePresence>
        {hasResult && !isLoading && (
          ...
          >
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-200/80 mt-1">
                    {result.error || 'Unable to verify bus connectivity right now.'}
                  </p>
                  <button
                    onClick={runCheck}
            ...
            {result.success && (
              <div className="bg-[#071712]/80 border border-white/10 rounded-2xl p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-extrabold text-white">🚌 Bus</p>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <h4 className="text-lg font-extrabold text-white mt-2 leading-snug">
                      Sorry, Bus service is not available at {result.airportName}.
                    </h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <h4 className="text-base font-extrabold text-white mt-2">
                      We could not verify Bus availability.
                    </h4>
                    <p className="text-xs text-slate-300 mt-2 leading-relaxed">
                      We could not verify the availability of Bus service for {result.airportName}.
                      Please check the official airport website for the latest information.
                    </p>
                  </div>
                </div>
            ...
            {result.success && result.status === 'Available' && (
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-emerald-950/30 via-[#071712] to-[#071712] border border-emerald-500/40 rounded-2xl p-6 shadow-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <h4 className="text-lg font-extrabold text-white mt-2 leading-snug">
                        Bus service is available at {result.airportName}.
                      </h4>
                      {result.reason && (
                        <p className="text-xs text-slate-300 mt-2 leading-relaxed">{result.reason}</p>
                      )}
                ...
                {result.officialWebsite && result.officialWebsite.url && (
                  <div className="bg-[#071712]/80 border border-emerald-500/20 rounded-2xl p-5 space-y-3">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-xs font-bold text-emerald-300 hover:text-white bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 rounded-xl px-4 py-2 transition-all"
                    >
                ...
                {result.recommendedApp && result.recommendedApp.name && (
                  <div className="bg-[#071712]/80 border border-teal-500/20 rounded-2xl p-5 space-y-3">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div className="flex items-center gap-2.5">
                        <div className="w-9 h-9 rounded-xl bg-teal-500/20 border border-teal-500/30 flex items-center justify-center">
                          <Smartphone size={17} className="text-teal-400" />
                        </div>
                        <div>
                    ...
                    {result.recommendedApp.url ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-xs font-bold text-teal-300 hover:text-white bg-teal-500/10 hover:bg-teal-500/20 border border-teal-500/30 rounded-xl px-4 py-2 transition-all"
                      >
                ...
                {result.trackingInformation && (
                  <div className="bg-[#071712]/80 border border-white/10 rounded-2xl p-5 space-y-3">
                    <div className="flex items-center gap-2.5">
                      <div
