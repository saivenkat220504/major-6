...
console.log('Result with isFinal=false:', cleanSpeechTranscript(mockResults.map(r => { r.isFinal = false; return r; })));
console.log('Result with isFinal=true:', cleanSpeechTranscript(mockResults.map(r => { r.isFinal = true; return r; })));
